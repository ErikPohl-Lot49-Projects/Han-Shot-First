                        ...
                        for selector_index, selector in \
                            ...
                            if (
                                    (
                                            ...
                                            current_json_key.lower() == 'identifier' and
                                            current_json_value.lower() ==
                                             offset_selector.lower()
                                    ) or
                                    (
                                            selector.startswith('.') and
                                            current_json_key.lower() ==
                                             'classnames' and
                                            offset_selector.lower() in
                                             [json_value.lower() for
                                              json_value in current_json_value]
                                    ) or
                                    (
                                            selector[0] not in 
