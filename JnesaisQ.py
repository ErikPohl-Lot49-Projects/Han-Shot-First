...
class JnesaisQ:
    ...
    def compare_verbose(self, JSON_to_query, JSON_query_clause=None,
        ...
        for format_key in JSON_query_clause.keys():
            ...
            if isinstance(JSON_query_key_value, list) and isinstance(JSON_query_clause[format_key], list):
                for clause in JSON_query_key_value:
                    print('evalute clause in key value against query clause ')
                    print('query clause type', type(JSON_query_clause[format_key]), JSON_query_clause[format_key])
                    print('list trouble')
                    print(JSON_query_key_value)
                    print(type(JSON_query_key_value))
                    for clause in JSON_query_key_value:
